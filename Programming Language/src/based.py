...
LETTERS = ENG_LETTERS + UA_LETTERS
...
class Error:
  ...
  def as_string(self):
    ...
    result += f'Файл {self.pos_start.fn}, рядок {self.pos_start.ln + 1}'
...
class ExpectedCharError(Error):
  def __init__(self, pos_start, pos_end, details):
    super().__init__(pos_start, pos_end, 'Очікуваний символ', details)
